...
var _GeneralInfo = require("../store/GeneralInfo");

var _reactstrap = require("reactstrap");

require("./Button.css");

var _FormComponents = require("../collaborator/FormComponents");

var _HttpProxy = require("../collaborator/HttpProxy");

var _DataModelling = require("../collaborator/DataModelling");
...
class ImplementationExample extends _react.Component {
  componentDidMount() {
    this.props.getCompanyInfo('erik');
    (0, _HttpProxy.HTTPProxy)({
  ...
  toggleExitTransaction() {
    ...
    this.setState(state => ({
      modalExitTransaction: modalState
    }));
  }
  ...
  togglePrintTransaction() {
    ...
    this.setState(state => ({
      modalPrintTransaction: modalState
    }));
  }

  updateListCommodity(newData) {
    this.setState(state => ({
      listCommodity: newData
    }));
  }

  updateListPengangkutan(newData) {
    this.setState(state => ({
      listPengangkutan: newData
    }));
  }

  updateListBongkarMuat(newData) {
    this.setState(state => ({
      listBongkarMuat: newData
    }));
  }
  ...
  constructor(props) {
    ...
    this.BongkarMuatDataModel = (0, _DataModelling.DataModelling)({
      fields: [{
        name: 'no_Kendaraan',
        header: 'No.Kendaraan',
        type: 'string',
        ...
        name: 'sumber_Komoditi',
        header: 'Sumber_Komoditi',
        type: 'string',
        showHeader: false
      }, {
        name: 'spesifikasi_Komoditi',
        header: 'Spesifikasi_Komoditi',
        type: 'string',
        showHeader: false
      }, {
        name: 'komoditi_Group',
        header: 'Komoditi_Group',
        type: 'string',
        showHeader: false
      }, {
        ...
        name: 'data_STNK_Kendaraan',
        header: 'Data_STNK_Kendaraan',
        type: 'string',
        showHeader: false
      }, {
        name: 'dataTarra_Kendaraan',
        header: 'DataTarra_Kendaraan',
        type: 'string',
        showHeader: false
      }, {
        name: 'jumlah_Segel',
        ...
        name: 'keterangan_Muatan',
        header: 'Keterangan_Muatan',
        type: 'string',
        showHeader: false
      }, {
        name: 'userID',
    ...
    this.CommodityDataModel = (0, _DataModelling.DataModelling)({
      fields: [{
        name: 'komoditi',
        header: 'Komoditi',
        type: 'string',
        ...
        name: 'type_Spesifikasi',
        header: 'Type_Spesifikasi',
        type: 'string',
        showHeader: true
      }, {
        name: 'type_Pengangkutan',
        header: 'Type_Pengangkutan',
        type: 'string',
        showHeader: true
      }, {
        name: 'sales_ProductCode',
        header: 'Sales_ProductCode',
        type: 'string',
        showHeader: true
      }, {
        name: 'type_Storage',
        ...
        name: 'keterangan_Komoditi',
        header: 'Keterangan_Komoditi',
        type: 'string',
        showHeader: true
      }, {
        name: 'userID',
    ...
    this.PengangkutanDataModel = (0, _DataModelling.DataModelling)({
      fields: [{
        name: 'pengangkutan_ID',
        header: 'Pengangkutan_ID',
        type: 'string',
        showHeader: true
      }, {
        name: 'nama_Pengangkutan',
        header: 'Nama_Pengangkutan',
        type: 'string',
        showHeader: true
      }, {
        name: 'initial',
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, /*#__PURE__*/_react.default.createElement(_FormComponents.FormModalWrapper, {
      className: '',
    ...
    }, /*#__PURE__*/_react.default.createElement(_FormComponents.GenerateInputGroup, {
    ...
    }), /*#__PURE__*/_react.default.createElement(_FormComponents.GenerateButton, {
      className: 'btn btn-primary',
      name: 'LookupButton',
      ...
      color: "primary",
      onClick: this.togglePrintTransaction
    }, "Simpan"), /*#__PURE__*/_react.default.createElement(_reactstrap.Button, {
      color: "secondary",
      onClick: this.toggle
    }, "Cancel"))), /*#__PURE__*/_react.default.createElement(_FormComponents.FormModalWrapper, {
      className: '',
      headerTitle: 'Daftar Komoditi Timbang Muat',
      onToggleMethod: this.modalCommodity,
      name: 'ModalCommodity',
      isOpen: this.state.modalCommodity
    }, /*#__PURE__*/_react.default.createElement(_reactstrap.ModalBody, null, /*#__PURE__*/_react.default.createElement(_FormComponents.TableWrapper, {
      ...
      name: 'PengangkutanTable' // doubleClickEvent={this.processModalPengangkutan}

    })), /*#__PURE__*/_react.default.createElement(_reactstrap.ModalFooter, null, /*#__PURE__*/_react.default.createElement(_reactstrap.Button, {
      color: "secondary",
      onClick: this.togglePengangkutan
    }, "Cancel"))), renderCompanyNameHeader(this.props), /*#__PURE__*/_react.default.createElement(_FormComponents.GenerateNotificationPopup, {
      className: '',
    ...
    }), /*#__PURE__*/_react.default.createElement(_FormComponents.GenerateNotificationPopup, {
      className: '',
      ...
      label: "Cetak Tiket"
    }), /*#__PURE__*/_react.default.createElement(_FormComponents.GenerateInputText, {
      className: 'btn btn-primary',
    ...
    }), /*#__PURE__*/_react.default.createElement(_FormComponents.TableWrapper, {
...
function renderCompanyNameHeader(props) {
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h1", null, props.companyName.companyName));
}

var _default = (0, _reactRedux.connect)(state => state.generalInfo, dispatch => (0, _redux.bindActionCreators)(_GeneralInfo.actionCreatorsGeneralInfo, dispatch))(ImplementationExample);
